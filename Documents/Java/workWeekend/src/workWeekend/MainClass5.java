...
public class MainClass5 {
	...
	static int[][] cvint(String info[][]) {
		
		int infoPt[][] = new int[info.length][5];
	...
	static void sumPrint(int infoPt[][], String info[][]) {
	...
	static int[] sum(String info[][],int infoPt[][]) {
		int sum[] = new int[info.length];
		for (int i=0; i < info.length; i++ ) {
	...
	static void sumKo(String info[][], int infoPt[][]) {
		int sumKo = 0;
		for (int i=0; i<info.length; i++) {
			sumKo += infoPt[i][2];
		}
	...
	static void maxEng(String info[][], int infoPt[][]) {
		int maxEng = 0;
		for (int i=0; i<info.length; i++) {
			for(int j=3; j<4; j++) {
	...
	static void minMath(String info[][], int infoPt[][]) {
		int minMath = 999;
		for (int i=0; i<info.length; i++) {
			for(int j=4; j<5; j++) {
	...
	// 학급에서 성적 1등의 이름 출력 
	static void first(int sum[], String info[][]) {
		int first= 0;
