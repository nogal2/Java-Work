...
public class MainClass {
	...
	static String decToHex(String numStr) {
		int num10 = Integer.parseInt(numStr);
		String num16 = Integer.toOctalString(num10);
		return num16;
	}
	static int twoTodec(String numStr) {
